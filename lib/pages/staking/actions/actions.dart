...
import 'package:polkawallet_plugin_dbc/pages/staking/actions/rewardsChart.dart';
...
class _StakingActions extends State<StakingActions> {
      ...
      return Container(
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: i.success!
                ? SvgPicture.asset(
                    'packages/polkawallet_plugin_dbc/assets/images/staking/ok.svg')
                : SvgPicture.asset(
                    'packages/polkawallet_plugin_dbc/assets/images/staking/error.svg'),
          ),
          title: Text(i.call!),
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: SvgPicture.asset(
                'packages/polkawallet_plugin_dbc/assets/images/staking/${isReward ? 'reward' : 'slash'}.svg'),
          ),
  ...
  Widget build(BuildContext context) {
    final Map<String, String>? dic =
        I18n.of(context)!.getDic(i18n_full_dic_dbc, 'staking');
...
class RowAccount02 extends StatelessWidget {
  ...
  void _showActions(BuildContext context) {
    final dic = I18n.of(context)!.getDic(i18n_full_dic_dbc, 'staking')!;
...
class StakingInfoPanel extends StatelessWidget {
  ...
  void _showUnlocking(BuildContext context) {
    final dic = I18n.of(context)!.getDic(i18n_full_dic_dbc, 'staking');
    final dicGov = I18n.of(context)!.getDic(i18n_full_dic_dbc, 'gov');
      ...
      builder: (BuildContext context) => CupertinoActionSheet(
        ...
        cancelButton: CupertinoActionSheetAction(
          child: Text(I18n.of(context)!
              .getDic(i18n_full_dic_dbc, 'common')!['cancel']!),
          onPressed: () {
            Navigator.pop(context);
          },
        ),

...
class _CouncilState extends State<Council> {
  ...
  Future<void> _submitCancelVotes() async {
    final govDic = I18n.of(context)!.getDic(i18n_full_dic_dbc, 'gov')!;
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          ...
          content: Text(I18n.of(context)!
              .getDic(i18n_full_dic_dbc, 'gov')!['vote.remove.confirm']!),
          actions: [
            CupertinoButton(
                  ...
                  child: Column(
                    children: widget.plugin.store.gov.council.members!.map((i) {
                      return CandidateItem(
                        ...
                        icon:
                            widget.plugin.store.accounts.addressIconsMap[i[0]],
                        balance: i,
                        tokenSymbol: symbol,
                        decimals: decimals,
                      );
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: balance!.length == 1
          ? null
          : Text(
              '${I18n.of(context)!.getDic(i18n_full_dic_dbc, 'gov')!['backing']}: ${Fmt.token(

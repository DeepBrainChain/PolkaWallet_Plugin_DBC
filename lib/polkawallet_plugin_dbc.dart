library polkawallet_plugin_dbc;
...
import 'package:polkawallet_plugin_dbc/pages/governance.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/council/candidateDetailPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/council/candidateListPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/council/councilPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/council/councilVotePage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/council/motionDetailPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/democracy/democracyPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/democracy/proposalDetailPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/democracy/referendumVotePage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/treasury/spendProposalPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/treasury/submitProposalPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/treasury/submitTipPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/treasury/tipDetailPage.dart';
import 'package:polkawallet_plugin_dbc/pages/governance/treasury/treasuryPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/bondExtraPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/controllerSelectPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/payoutPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/rebondPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/redeemPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/rewardDetailPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/setControllerPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/setPayeePage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/stakePage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/stakingDetailPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/actions/unbondPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/validators/nominatePage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/validators/validatorChartsPage.dart';
import 'package:polkawallet_plugin_dbc/pages/staking/validators/validatorDetailPage.dart';
import 'package:polkawallet_plugin_dbc/service/index.dart';
import 'package:polkawallet_plugin_dbc/store/cache/storeCache.dart';
import 'package:polkawallet_plugin_dbc/store/index.dart';
...
class PluginDBC extends PolkawalletPlugin {
  ...
  final Map<String, Widget> tokenIcons = {
    'DBC': Image.asset(
        'packages/polkawallet_plugin_dbc/assets/images/tokens/DBC.png'),
  };
  ...
  @override
  Future<void> onAccountChanged(KeyPairData dbc) async {
    _store.staking.loadAccountCache(dbc.pubKey);
  }
